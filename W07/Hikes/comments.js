...
// Comments: this code handles getting the list of comments from the model, and then passing them to the view to be rendered.
...
class Comments {
    ...
    addSubmitListener() {
        //  use element.ontouchend to avoid conflicts
